...
import 'package:todolisthive/time_widget.dart';
import 'package:todolisthive/widgets/auto_button.dart';
                      ...
                      showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              "You don't select a time,should write at least one task.",
                              style: TextStyle(
                                fontSize: 20,
                              ),
                            ),
